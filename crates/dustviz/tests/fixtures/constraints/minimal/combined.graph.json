...
//
// Snapshot-style test for JSON rendering with constraint overlay.
//
...
// - tests/fixtures/constraints/minimal/combined.graph.json
...
#[test]
fn json_with_constraints_matches_golden() {
